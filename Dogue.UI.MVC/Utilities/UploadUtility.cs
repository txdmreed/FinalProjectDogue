...
namespace Dogue.UI.MVC.Utilities
{
...
public class UploadUtility
{
    ...
    public static void Delete(string path, string fileName)
    {
        ...
        if (fileName.ToLower() == "noimage.png")//NOTE: This requires you to have a noimage.png in your project. If your default image name differs, change it here.
        {
            return;
        }
